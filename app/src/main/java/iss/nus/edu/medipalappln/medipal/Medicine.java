...
public class Medicine {
    ...
    public Medicine(String medName, String medDesc, int catId, int remindId, int quantity, int dosage, int threshold,
    ...
    public Medicine(int medId, String medName, String medDesc, int catId, int remindId, int quantity, int dosage, int threshold,
                    Date dateIssued, int expireFactor) {
        this.medId = medId;
        this.medName = medName;
        this.medDesc = medDesc;
