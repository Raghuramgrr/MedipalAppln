...
public class CategoryDAO extends DBDAO {
    ...
    public long update(Category category) {
        ...
        long result = database.update(DataBaseHelper.TABLE_CATEGORY, values,
                WHERE_ID_EQUALS,
                new String[] { String.valueOf(category.getFacilityNumber()) });
    ...
    public int delete(Category category) {
        return database.delete(DataBaseHelper.TABLE_CATEGORY, WHERE_ID_EQUALS,
                new String[] { category.getFacilityNumber() + "" });
    }
    ...
    public ArrayList<Category> getCategories() {
        ...
        while (cursor.moveToNext()) {
            ...
            Category category = new Category(id, fname, fdesc, fcode, freminder);
    ...
    public Category getFacility(long id) {
        ...
        if (cursor.moveToNext()) {
            ...
            category = new Category(fid, fname, fdesc, fcode, freminder);
