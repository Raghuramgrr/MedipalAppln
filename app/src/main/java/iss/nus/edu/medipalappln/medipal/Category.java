...
public class Category implements Comparable<Category> {
    ...
    public Category(String name, String description, String code, String reminder) {
        this.name = name;
        this.description = description;
    }

    public Category(int catId, String name, String description, String code, String reminder) {
        this.name = name;
        this.description = description;
        this.code = code;
