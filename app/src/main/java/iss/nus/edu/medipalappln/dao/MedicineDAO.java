...
public class MedicineDAO extends DBDAO {
    private static final String WHERE_ID_EQUALS = DataBaseHelper.REMINDER.ID + " =?";
...
//    }
    ...
    public Medicine getMember(long id) {
        ...
        if (cursor.moveToNext()) {
            ...
            medicine = new Medicine(mid, mName, mDesc, mCategory, mReminder, mQuantity, mDosage, mThreshold, mDateIssued, mExpiryFactor);
